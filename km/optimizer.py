...
class GradientDescent(Optimizer):
    ...
    def __init__(self, target, learning_rate=0.01, batch_size=32, **kwargs):
        Optimizer.__init__(self, target, batch_size, **kwargs)
...
class RMSProp(Optimizer):
    ...
    def __init__(self, target, learning_rate=0.01, beta=0.9, batch_size=32, **kwargs):
        Optimizer.__init__(self, target, batch_size, **kwargs)
        self.learning_rate = learning_rate
...
class Adam(Optimizer):
    ...
    def __init__(self, target, learning_rate=0.01, beta_1=0.9, beta_2=0.99, batch_size=32, **kwargs):
        Optimizer.__init__(self, target, batch_size, **kwargs)
        self.learning_rate = learning_rate
